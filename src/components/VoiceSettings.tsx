...
export const VoiceSettings: React.FC<VoiceSettingsProps> = ({ onClose, selectedVoiceURI, onSelectVoice, voiceSpeed, onSpeedChange }) => {
  ...
  return (
    <div style={{
      ...
      <div className="glass-panel" style={{ width: '90%', maxWidth: '500px', maxHeight: '90vh', display: 'flex', flexDirection: 'column', background: 'white', borderRadius: '16px', overflow: 'hidden' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.5rem 2rem', borderBottom: '1px solid #f0f0f0', flexShrink: 0 }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '1.5rem 2rem', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div style={{ padding: '1rem', background: '#fff1f2', borderRadius: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
